...
export default class SearchImages extends Component {
  ...
  fetchImages = () => {
    ...
    const url = `https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=062a6c0c49e4de1d78497d13a7dbb360&tags=${this.state.search}&per_page=20&page=${this.page}&format=json&nojsoncallback=1`;
    fetch(url + this.page)
